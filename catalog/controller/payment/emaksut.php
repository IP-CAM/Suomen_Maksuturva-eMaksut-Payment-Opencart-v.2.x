...
class ControllerPaymentEmaksut extends Controller {
	...
	public function index() {
		...
		return $this->load->view('default/template/payment/emaksut.tpl', $this->data);
	...
	public function callback() {
		...
		if ($error == '') {
			...
			$this->model_checkout_order->addOrderHistory($this->request->get['pmt_id'], $this->config->get('emaksut_order_status_id'));

			$message = '';

			$this->model_checkout_order->editOrder($this->request->get['pmt_id'], $this->config->get('emaksut_order_status_id'), $message, false);
	...
	public function callbackdelayed() {
		...
		if ($error == '') {
			...
			$this->model_checkout_order->addOrderHistory($this->request->get['pmt_id'], $this->config->get('emaksut_order_status_delayed_id'));

			$message = '';

			$this->model_checkout_order->editOrder($this->request->get['pmt_id'], $this->config->get('emaksut_order_status_delayed_id'), $message, false);
